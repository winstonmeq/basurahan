          ...
          <div className="flex flex-col gap-4 p-4 ">
            ...
            {images.map((item) => (
              <div key={item.id}>
                  ...
                  <CardHeader>
                    <CardTitle>
                      <div className="flex items-center bg-white justify-between">
                        {/* Left Side: Profile Image and Name/Email */}
                ...
                <div>
                  <CommentBoxTable userId={userId} imageId={item.id} url={item.filename}/>
                </div>
              </div>
            ))}
          </div>
